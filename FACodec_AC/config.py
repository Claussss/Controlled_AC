...
if False:
    ...
    class Config:
        ...
        exp_num = 110 # Default experiment name
        ...
        max_seq_len = 807
        r_range = (1., 1.) # Defines the lower and upper bound for the percentage of tokens 
                    # to drop in a contiguous segment when not dropping the entire sequence.
        p_drop = 1. # With probability p_drop, the entire sequence is masked.
        NOISE_MIN = 1.0
